 ...
 * 
 * for(int i = 1; i < A.length; i++){ //insertion sort code You could then state
 ...
 * 
 * Details The Input format and the constraints are the same as the previous
 * challenges and are presented below.
 * 
 * Input Format There will be two lines of input:
 * 
 * s - the size of the array ar - the list of numbers that makes up the array
 * Output Format Output the numbers in order, space-separated.
 * 
 * Constraints 1<=s<=1000 -1500<=x<= 1500 , x ∈ ar
 * 
 * Sample Input
 * 
 * 6 1 4 3 5 6 2 Sample Output
 * 
 * 1 2 3 4 5 6 Suggest Edits
 */
