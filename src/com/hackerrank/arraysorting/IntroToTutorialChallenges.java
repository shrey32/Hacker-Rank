 ...
 * where you'll get to apply your learnings.
 * 
 ...
 * sorted array (ar) and a number (V), can you print the index location of V in
 * the array?
 * 
 ...
 * 
 * V - the value that has to be searched. n - the size of the array. ar - n
 * numbers that make up the array. Output Format Output the index of V in the
 * array.
 * 
 ...
 * 
 * Constraints 1<=n<=1000 -1000 <=x <= 1000 , x ∈ ar
 * 
 ...
 * Sample Input
 * 
 * 4 6 1 4 5 7 9 12 Sample Output
 * 
 * 1 Explanation V = 4. The 4 is located in the 1st spot on the array, so the
 * answer is 1.
 */
