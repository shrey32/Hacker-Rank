 ...
 * currently) its correct place. Since the array composed of just the first
 ...
 * 
 * Constraints 1<=s<=1000 -10000<=x<= 10000 , x ∈ ar
 * 
 * Sample Input
 * 
 * 6 1 4 3 5 6 2 
 ...
 * sorted.
 * 
 * Task The method insertionSort takes in one parameter: ar, an unsorted array.
 ...
 *
 */
public class InsertionSortPart_2 {
